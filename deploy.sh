#!/bin/bash
#Author: Luis Díaz
#Script para implementar una web de GitHub
...
echo -e "\n${LGREEN}El servidor está actualzando....${NC}"
...
if dpkg -s mariadb-server >  /dev/null 2>&1; then
  echo -e "\n${LBLUE}El servidor está actualizando....${NC}"
else
...
#Crear script para insertar datos en tabla
...
if dpkg -s apache2 > /dev/null 2>&1; then
  echo -e "\n${LBLUE}El servicio Apache 2 está instalado...${NC}"
else
